...
patchwork::wrap_plots(list(p1, p2, p3, p4, p5, p6, p8))
```
...
correlation::correlation(
  dfsub[c("Simulation_Monitoring", "Confidence_Fake_Model", "Confidence_Real_Model")],
...
plot_correlation <- function(dfsub, x = "Confidence_Real", y = "IPIP6_Openness", xlab = x, ylab = y, fill = "grey") {
...
plot_correlation(dfsub,
  x = "Confidence_Real",
  y = "IPIP6_HonestyHumility",
  xlab = "Confidence_Real",
  ylab = "IPIP6_HonestyHumility",
  fill = "grey"
)
```
